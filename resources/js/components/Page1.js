...
function PageOne(props) {
    ...
    useEffect(() => {
        ...
        GraphsData().then(async (result) => {
            ...
            let IndgraphDataRender = result.Industry_Count.slice(1, 11).map((e) => { return e.name });
            let IndgraphDataRender2 = result.Industry_Count.slice(1, 11).map((e) => { return e.value });
    ...
    useEffect(() => {
        ...
        const myChart = new Chart(ctx, {
            type: 'horizontalBar',
            data: {
                labels: IndbarChartDataName,
                datasets: [{
                    label: 'Respective Count',
                    data: IndbarChartDataName2,
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
                        'rgba(255, 206, 86, 0.2)',
                ...
                <div className='row m-0'>
                                ...
                                <div className="top_input">
                                    ...
                                    <div className='row'>
                                        <div className='col-11'>
                                            {
                                                pName != "" && searchBox &&
                                                <div style={{ maxHeight: "200px", border: "1px solid gray", overflow: "auto", zIndex: 999, backgroundColor: "#fff", width: 'auto', marginLeft: 7, marginRight: 14 }}>
                                                    {
                                    ...
                                    <div className="row top_pad">
                                        ...
                                        <div className="col-10">
                                            <div style={{ display: "flex" }}>
                                                ...
                                                <span className="pName">Role 4</span>
                                            </div>
                                            <div className="top_input">
                                                <input
                    ...
                    <div className="col-6">
                        ...
                        <ul className="nav nav-tabs" style={{ width: "90%", marginLeft: 10 }}>
                            ...
                            <button className='btn btn-primary' onClick={onClickHeat}>Heat Map</button>
                        </ul>
